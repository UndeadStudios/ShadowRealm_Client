...
public class AnimationKeyFrame {
   ...
   public int deserialise(Buffer packet, int version) {
      ...
      this.start_interpolation_type = InterpolationType.lookup_by_id(packet.readUnsignedByte());
      this.end_interpolation_type = InterpolationType.lookup_by_id(packet.readUnsignedByte());
      this.interpolate_timing = packet.readUnsignedByte() != 0;
